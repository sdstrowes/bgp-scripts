...
cisco_clean="/mnt/ext/sds/clean-tables/route-views.1
 /mnt/ext/sds/clean-tables/route-views.3"

# The following MUST correspond to the order above.
mrt_local_tags="route-views.eqix
 route-views.isc
 route-views.kixp
 route-views.linx
 route-views.wide
